...
/**
 * Variant that stores each element based on the Thread's id in a ConcurrentSkipListMap and doesn't bother too much with its capacity.
 *
 * @author Arjen van der Meijden (acm@tweakers.net)
 */
@State(Scope.Benchmark)
public class ThreadIdSkipListMapFixedMultiThreadedFormatBench extends AbstractMultiThreadedFormatBench
{
